...
class MyModel(nn.Module):
    ...
    def forward(self, sentences_list):  # [4*3336, 7*336, 1*336]
        ...
        output = self.softmax(self.hidden2tag(sentence_embeddings_list))  # sentence_num * 3
    ...
    def save(self):
        torch.save(self, 'models/model_sentence_level_BiLSTM_author_3_class_' + str(self.random_seed) + '.pt')

    def load(self):
        return torch.load('models/model_sentence_level_BiLSTM_author_3_class_' + str(self.random_seed) + '.pt')
