...
def train_and_valid_extra(model, optimizer, train_batch_list, valid_data_list, total_epoch):
...
def train_and_valid_extra_2_C(model, optimizer, train_batch_list, valid_data_list, total_epoch):
