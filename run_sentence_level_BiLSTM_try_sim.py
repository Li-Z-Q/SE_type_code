...
if __name__ == '__main__':
    ...
    open('output/sentence_level_BiLSTM/sim/test_acc/' + str(np.mean(np.array(test_acc_list))) + '.txt', 'w')
    open('output/sentence_level_BiLSTM/sim/test_f1/' + str(np.mean(np.array(test_f1_list))) + '.txt', 'w')
    open('output/sentence_level_BiLSTM/sim/valid_acc/' + str(np.mean(np.array(valid_best_acc_list))) + '.txt', 'w')
    open('output/sentence_level_BiLSTM/sim/valid_f1/' + str(np.mean(np.array(valid_best_f1_list))) + '.txt', 'w')