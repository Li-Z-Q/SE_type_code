...
CUDA_VISIBLE_DEVICES=2 nohup python run_paragraph_level_BiLSTM_try_sim_weight_average_gold.py > output/paragraph_level_bilstm/log_paragraph_level_BiLSTM_300_try_sim_weight_average_gold.txt &
...
CUDA_VISIBLE_DEVICES=2 nohup python run_sentence_level_BERT_try_sim_weight_average_gold.py > output/sentence_level_bert/log_sentence_level_BERT_try_sim_weight_average_gold.txt &
