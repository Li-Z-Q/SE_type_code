...
from models.sentence_level_BiLSTM_try_sim_weight_average_gold import MyModel
...
if __name__ == '__main__':
    ...
    for t in range(5):
        ...
        torch.save(best_model, 'output/model_sentence_level_BiLSTM_try_sim_weight_average_gold.pt')
