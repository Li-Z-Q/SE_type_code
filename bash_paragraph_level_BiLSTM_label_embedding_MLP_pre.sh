...
#  > output/paragraph_level_BiLSTM/label_embedding_MLP_pre_True_-3.0/log_paragraph_level_BiLSTM_300_label_embedding_MLP_pre_0.txt &
#
#CUDA_VISIBLE_DEVICES=6 nohup \
#  python run_paragraph_level_BiLSTM_label_embedding_MLP_pre.py \
#    --fold_num 1 --cheat True --mask_p -3.0 \
#  > output/paragraph_level_BiLSTM/label_embedding_MLP_pre_True_-3.0/log_paragraph_level_BiLSTM_300_label_embedding_MLP_pre_1.txt &
#
#CUDA_VISIBLE_DEVICES=6 nohup \
#  python run_paragraph_level_BiLSTM_label_embedding_MLP_pre.py \
#    --fold_num 2 --cheat True --mask_p -3.0 \
#  > output/paragraph_level_BiLSTM/label_embedding_MLP_pre_True_-3.0/log_paragraph_level_BiLSTM_300_label_embedding_MLP_pre_2.txt &
...
########################################################### cheat = False, mask_p = 0.0, independent = True, grad = False
CUDA_VISIBLE_DEVICES=7 nohup \
  python run_paragraph_level_BiLSTM_label_embedding_MLP_pre.py \
    --fold_num 0 --cheat False --mask_p 0.0 --if_use_independent 1 --bilstm_1_grad 0 \
...
CUDA_VISIBLE_DEVICES=7 nohup \
  python run_paragraph_level_BiLSTM_label_embedding_MLP_pre.py \
    --fold_num 1 --cheat False --mask_p 0.0 --if_use_independent 1 --bilstm_1_grad 0 \
...
CUDA_VISIBLE_DEVICES=7 nohup \
  python run_paragraph_level_BiLSTM_label_embedding_MLP_pre.py \
    --fold_num 3 --cheat False --mask_p 0.0 --if_use_independent 1 --bilstm_1_grad 0 \
